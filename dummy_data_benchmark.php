...
//Retrieve static(ranks)/default(clubs) info
...
//stop1 users benchmark
$stop1 = microtime(true) - $start - $rt_so_far;
$rt_so_far = $stop1;
...
//stop2 clubs benchmark
$stop2 = microtime(true) - $start - $rt_so_far;
$rt_so_far = $stop2;
echo "Stop 2: $stop2 sec.<br/>\r\n";

//3. Fetch new Users and Cups (& static positions)
echo ("3. Fetch Users and Cups (& static positions)<br/>\r\n");
...
//stop4 availabilities benchmark
...
//stop5 pairing benchmark
$stop5 = microtime(true) - $start - $rt_so_far;
$rt_so_far = $stop5;
echo "Stop 5: $stop5 sec.<br/>\r\n";

//6. Queries for Club/User in random order

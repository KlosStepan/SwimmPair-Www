    ...
    <div class="tab-content">
        ...
        <div id="signup">
            ...
            <form action="index.php" method="post" autocomplete="off">
                ...
                <div class="field-wrap">
                    <label class="active">
                        Klubová příslušnost<span class="req">*</span>
                    </label>
...
?>
                ...
                <div class="field-wrap">
                    <select name="pozice">
                        <option value="0">Jsem plavecký rozhodčí</option>
                        <option value="1">Jsem vedoucím klubu</option>
                    </select>
                    <label class="active">
...
<?php endforeach; ?>
                    ...
                    <label class="active">
                        Rozhodcovská třída<span class="req">*</span> </br>
                    </label>
                </div>

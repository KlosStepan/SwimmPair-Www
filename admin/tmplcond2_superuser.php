<!--<p align="center">Vy jste určitě <span class="red">správce</span>!</p>-->
<h3>ADMINISTRATIVA</h3>
<ul id="nabidkavadminu">
    <li class="left-split" onclick="location.href = 'pridat_aktualitu.php';"><div>PŘIDAT AKTUALITU</div></li>
    <li class="right-split" onclick="location.href = 'editovat_aktuality.php';"><div>EDITOVAT AKTUALITU</div></li>
    <li onclick="location.href = 'nove_registrovani.php';"><div>SCHVÁLIT NOVÉ LIDI</div></li>
    <li onclick="location.href = 'rozhodci_zavody.php';"><div>PŘIŘAZOVÁNÍ ROZHODČÍCH NA POZICE</div></li>
    <li class="left-split" onclick="location.href = 'zaregistrovat_uzivatele.php';"><div>ZAREGISTROVAT ČLOVĚKA</div></li>
    <!-- ADDING THIS SHIT, NOT IN THE MOBILE APP -->
    ...
    <!--<li onclick="location.href = 'nova_pravidla.php';"><div>NAHRÁT NOVÁ PRAVIDLA</div></li>-->
    <li onclick="location.href = 'editovat_stranku.php?id=1';"><div>EDITOVAT KONTAKTY</div></li>
    <!--<li><a href="other.php">OTHER MAYBE...</a></li>-->
</ul>